...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS entries(
      ...
      receive_date TEXT, out_date TEXT, in_date TEXT,
      ready_date TEXT, return_date TEXT, reject_date TEXT,
...
def ink_in():
    ...
    cur = conn.cursor()
    cur.execute("""
    UPDATE ink_stock SET qty=qty+%s, updated_at=%s WHERE ink_id=%s
...
def ink_sell():
    ...
    cur = conn.cursor()
    cur.execute("""
    UPDATE ink_stock SET qty=qty-%s, updated_at=%s WHERE ink_id=%s AND qty>=%s
